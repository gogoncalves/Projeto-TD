...
function enviarResultadoQuiz (req, res)
{
    let fkUsuario = req.body.fkUsuarioServer;
    let porcentagem = req.body.porcentagemServer;
    ...
    {
        res.status(400).send("A porcentagem está undefined");
    }
    else 
    {
        usuarioModel.enviarResultadoQuiz(fkUsuario, porcentagem)
            .then((resposta) => {
